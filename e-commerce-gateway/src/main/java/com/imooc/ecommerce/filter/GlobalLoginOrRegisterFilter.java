...
public class GlobalLoginOrRegisterFilter implements GlobalFilter, Ordered {
    ...
    public Mono<Void> filter(ServerWebExchange exchange, GatewayFilterChain chain) {
        ...
        // 不要选择错误 import org.springframework.http.server.reactive.ServerHttpRequest;
        //  import org.springframework.http.server.reactive.ServerHttpResponse;
        ...
        // 3.访问其他的服务，则鉴权，校验是否能够从 Token 解析出用户信息
    ...
    private String parseBodyFromRequest(ServerHttpRequest request) {
        ...
        body.subscribe(buffer -> {
            ...
            // 一定要使用 DataBufferUtils.release 释放掉，否则会出现内存泄露
