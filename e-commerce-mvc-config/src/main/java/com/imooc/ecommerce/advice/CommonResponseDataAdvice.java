...
public class CommonResponseDataAdvice implements ResponseBodyAdvice<Object> {
     ...
     * @param aClass
     * @return 返回 false 不需要包装，返回 true 需要包装 --> beforeBodyWrite
     */
    @Override
    ...
    public boolean supports(MethodParameter methodParameter,
        ...
        // 通过 .getDeclaringClass() 获取是否为 IgnoreResponseAdvice.class 中的注解
        if (methodParameter.getDeclaringClass()
                .isAnnotationPresent(IgnoreResponseAdvice.class)) {
            return false;
        }

        // 通过 .getMethod()获取是否为 IgnoreResponseAdvice.class 中的注解
    ...
    public Object beforeBodyWrite(Object o, MethodParameter methodParameter,
        ...
        if (null == o){
            ...
            // o instanceof CommonResponse 判断 o 本身是否为一个 CommonResponse 类型
